...
Task 3
```
Using implementation of task 1, extend your Python script to export data in the JSON format.
...
Task 4
```
Using implementation of task 2, extend your Python script to export data in the JSON format.
...
File **3-dictionary_of_list_of_dictionaries.py** contains the implementation.
```
